...
UPDATE customer_support_transcripts
SET transcript =
'Agent (AG): Good afternoon! Thank you for calling SkyBlue Airlines. How can I assist you today?

Customer (CU): Hi there! I\'m flying with you next week and wanted to check on the in-flight meal options. I have some dietary restrictions.

AG: Of course, I\'d be happy to help with that. Could you please tell me your booking reference number and the flight details?

CU: Sure, my booking reference is ABC123, and I\'m flying from New York to London next Wednesday.

AG: Thank you for providing that. I see your booking here. We offer a variety of meals to cater to different dietary needs. Could you please tell me more about your dietary restrictions?

CU: I\'m vegetarian, and I also have a lactose intolerance. I was hoping to see if there are any suitable meal options for me.

AG: I appreciate you letting us know. We have a vegetarian meal option that is also lactose-free. It\'s a vegetable stir-fry with tofu and rice, and it comes with a fruit salad for dessert. Would that work for you?

CU: That sounds perfect! I\'m glad you have an option that fits my needs.

AG: I\'m glad to hear that! I\'ve noted your meal preference in your booking. Is there anything else I can assist you with today?

CU: No, that\'s all I needed. Thank you so much for your help!

AG: You\'re very welcome! We\'re here to make your journey as comfortable as possible. Have a great flight with us, and if you have more questions before your trip, don\'t hesitate to call back.

CU: Thanks again! I really appreciate your assistance. Have a great day!

AG: You too! Safe travels.'
WHERE call_id = '015';
